...
public class BetterToolsModJeiInformation implements IModPlugin {
	...
	public ResourceLocation getPluginUid() {
		return ResourceLocation.parse("better_tools:information");
	}
	...
	public void registerRecipes(IRecipeRegistration registration) {
		...
		registration
				.addIngredientInfo(
						List.of(new ItemStack(BetterToolsModItems.CRYSTALLITE_ARMOR_HONEY_HELMET.get()), new ItemStack(BetterToolsModItems.CRYSTALLITE_ARMOR_HONEY_CHESTPLATE.get()),
								new ItemStack(BetterToolsModItems.CRYSTALLITE_ARMOR_HONEY_LEGGINGS.get()), new ItemStack(BetterToolsModItems.CRYSTALLITE_ARMOR_HONEY_BOOTS.get())),
						VanillaTypes.ITEM_STACK, Component.translatable("jei.better_tools.crystallite_armor_honey_info"));
		registration
				.addIngredientInfo(
						List.of(new ItemStack(BetterToolsModItems.CRYSTALLITE_ARMOR_IRON_HELMET.get()), new ItemStack(BetterToolsModItems.CRYSTALLITE_ARMOR_IRON_CHESTPLATE.get()),
								new ItemStack(BetterToolsModItems.CRYSTALLITE_ARMOR_IRON_LEGGINGS.get()), new ItemStack(BetterToolsModItems.CRYSTALLITE_ARMOR_IRON_BOOTS.get())),
						VanillaTypes.ITEM_STACK, Component.translatable("jei.better_tools.crystallite_armor_iron_info"));
		registration
				.addIngredientInfo(
		...
		registration.addIngredientInfo(
				...
				VanillaTypes.ITEM_STACK, Component.translatable("jei.better_tools.crystallite_armor_nether_diamond_info"));
		registration.addIngredientInfo(
				List.of(new ItemStack(BetterToolsModItems.CRYSTALLITE_ARMOR_NETHERITE_HELMET.get()), new ItemStack(BetterToolsModItems.CRYSTALLITE_ARMOR_NETHERITE_CHESTPLATE.get()),
		...
		registration.addIngredientInfo(
				...
				VanillaTypes.ITEM_STACK, Component.translatable("jei.better_tools.crystallite_armor_sapphire_info"));
		registration
				.addIngredientInfo(
		...
		registration
				.addIngredientInfo(
						List.of(new ItemStack(BetterToolsModItems.CRYSTALLITE_ARMOR_TOPAZ_HELMET.get()), new ItemStack(BetterToolsModItems.CRYSTALLITE_ARMOR_TOPAZ_CHESTPLATE.get()),
								new ItemStack(BetterToolsModItems.CRYSTALLITE_ARMOR_TOPAZ_LEGGINGS.get()), new ItemStack(BetterToolsModItems.CRYSTALLITE_ARMOR_TOPAZ_BOOTS.get())),
						VanillaTypes.ITEM_STACK, Component.translatable("jei.better_tools.crystallite_armor_topaz_info"));
		registration.addIngredientInfo(
		...
		registration.addIngredientInfo(
				List.of(new ItemStack(BetterToolsModBlocks.DARK_POLISHED_COAL_BLOCK.get()), new ItemStack(BetterToolsModBlocks.DARK_POLISHED_COAL_SLAB.get()), new ItemStack(BetterToolsModBlocks.DARK_POLISHED_COAL_STAIRS.get()),
						new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_COAL_BLOCK.get()), new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_COAL_SLAB.get()), new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_COAL_STAIRS.get()),
						new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_IRON_BLOCK.get()), new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_IRON_SLAB.get()), new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_IRON_STAIRS.get()),
						new ItemStack(BetterToolsModBlocks.DARK_POLISHED_IRON_BLOCK.get()), new ItemStack(BetterToolsModBlocks.DARK_POLISHED_IRON_SLAB.get()), new ItemStack(BetterToolsModBlocks.DARK_POLISHED_IRON_STAIRS.get()),
						new ItemStack(BetterToolsModBlocks.DARK_POLISHED_LAPIS_BLOCK.get()), new ItemStack(BetterToolsModBlocks.DARK_POLISHED_LAPIS_SLAB.get()), new ItemStack(BetterToolsModBlocks.DARK_POLISHED_LAPIS_STAIRS.get()),
						new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_LAPIS_BLOCK.get()), new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_LAPIS_SLAB.get()), new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_LAPIS_STAIRS.get()),
						new ItemStack(BetterToolsModBlocks.POLISHED_DIAMOND_BLOCK.get()), new ItemStack(BetterToolsModBlocks.POLISHED_DIAMOND_SLAB.get()), new ItemStack(BetterToolsModBlocks.POLISHED_DIAMOND_STAIRS.get()),
						new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_EMERALD_BLOCK.get()), new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_EMERALD_SLAB.get()), new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_EMERALD_STAIRS.get()),
						new ItemStack(BetterToolsModBlocks.DARK_POLISHED_EMERALD_BLOCK.get()), new ItemStack(BetterToolsModBlocks.DARK_POLISHED_EMERALD_SLAB.get()), new ItemStack(BetterToolsModBlocks.DARK_POLISHED_EMERALD_STAIRS.get()),
						new ItemStack(BetterToolsModBlocks.POLISHED_REDSTONE_BLOCK.get()), new ItemStack(BetterToolsModBlocks.POLISHED_REDSTONE_SLAB.get()), new ItemStack(BetterToolsModBlocks.POLISHED_REDSTONE_STAIRS.get()),
						new ItemStack(BetterToolsModBlocks.POLISHED_RUBY_BLOCK.get()), new ItemStack(BetterToolsModBlocks.POLISHED_RUBY_SLAB.get()), new ItemStack(BetterToolsModBlocks.POLISHED_RUBY_STAIRS.get()),
						new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_COPPER_BLOCK.get()), new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_COPPER_SLAB.get()), new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_COPPER_STAIRS.get()),
						new ItemStack(BetterToolsModBlocks.DARK_POLISHED_COPPER_BLOCK.get()), new ItemStack(BetterToolsModBlocks.DARK_POLISHED_COPPER_SLAB.get()), new ItemStack(BetterToolsModBlocks.DARK_POLISHED_COPPER_STAIRS.get()),
						new ItemStack(BetterToolsModBlocks.POLISHED_TOPAZ_BLOCK.get()), new ItemStack(BetterToolsModBlocks.POLISHED_TOPAZ_SLAB.get()), new ItemStack(BetterToolsModBlocks.POLISHED_TOPAZ_STAIRS.get()),
						new ItemStack(BetterToolsModBlocks.POLISHED_GOLD_BLOCK.get()), new ItemStack(BetterToolsModBlocks.POLISHED_GOLD_SLAB.get()), new ItemStack(BetterToolsModBlocks.POLISHED_GOLD_STAIRS.get()),
						new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_GOLD_BLOCK.get()), new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_GOLD_SLAB.get()), new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_GOLD_STAIRS.get()),
						new ItemStack(BetterToolsModBlocks.POLISHED_NETHER_DIAMOND_BLOCK.get()), new ItemStack(BetterToolsModBlocks.POLISHED_NETHER_DIAMOND_SLAB.get()), new ItemStack(BetterToolsModBlocks.POLISHED_NETHER_DIAMOND_STAIRS.get()),
						new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_NETHER_DIAMOND_BLOCK.get()), new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_NETHER_DIAMOND_SLAB.get()),
						new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_NETHER_DIAMOND_STAIRS.get()), new ItemStack(BetterToolsModBlocks.POLISHED_AMETHYST_BLOCK.get()), new ItemStack(BetterToolsModBlocks.POLISHED_AMETHYST_SLAB.get()),
						new ItemStack(BetterToolsModBlocks.POLISHED_AMETHYST_STAIRS.get()), new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_AMETHYST_BLOCK.get()), new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_AMETHYST_SLAB.get()),
						new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_AMETHYST_STAIRS.get()), new ItemStack(BetterToolsModBlocks.DARK_POLISHED_COAL_TRAPDOOR.get()), new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_COAL_TRAPDOOR.get()),
						new ItemStack(BetterToolsModBlocks.DARK_POLISHED_IRON_TRAPDOOR.get()), new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_IRON_TRAPDOOR.get()), new ItemStack(BetterToolsModBlocks.DARK_POLISHED_LAPIS_TRAPDOOR.get()),
						new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_LAPIS_TRAPDOOR.get()), new ItemStack(BetterToolsModBlocks.POLISHED_DIAMOND_TRAPDOOR.get()), new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_EMERALD_TRAPDOOR.get()),
						new ItemStack(BetterToolsModBlocks.DARK_POLISHED_EMERALD_TRAPDOOR.get()), new ItemStack(BetterToolsModBlocks.POLISHED_REDSTONE_TRAPDOOR.get()), new ItemStack(BetterToolsModBlocks.POLISHED_RUBY_TRAPDOOR.get()),
						new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_COPPER_TRAPDOOR.get()), new ItemStack(BetterToolsModBlocks.DARK_POLISHED_COPPER_TRAPDOOR.get()), new ItemStack(BetterToolsModBlocks.POLISHED_TOPAZ_TRAPDOOR.get()),
						new ItemStack(BetterToolsModBlocks.POLISHED_GOLD_TRAPDOOR.get()), new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_GOLD_TRAPDOOR.get()), new ItemStack(BetterToolsModBlocks.POLISHED_NETHER_DIAMOND_TRAPDOOR.get()),
						new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_NETHER_DIAMOND_TRAPDOOR.get()), new ItemStack(BetterToolsModBlocks.POLISHED_AMETHYST_TRAPDOOR.get()),
						new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_AMETHYST_TRAPDOOR.get()), new ItemStack(BetterToolsModBlocks.DARK_POLISHED_COAL_WALL.get()), new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_COAL_WALL.get()),
						new ItemStack(BetterToolsModBlocks.DARK_POLISHED_IRON_WALL.get()), new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_IRON_WALL.get()), new ItemStack(BetterToolsModBlocks.DARK_POLISHED_LAPIS_WALL.get()),
						new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_LAPIS_WALL.get()), new ItemStack(BetterToolsModBlocks.POLISHED_DIAMOND_WALL.get()), new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_EMERALD_WALL.get()),
						new ItemStack(BetterToolsModBlocks.DARK_POLISHED_EMERALD_WALL.get()), new ItemStack(BetterToolsModBlocks.POLISHED_REDSTONE_WALL.get()), new ItemStack(BetterToolsModBlocks.POLISHED_RUBY_WALL.get()),
						new ItemStack(BetterToolsModBlocks.LIGHT_POLISHED_COPPER_WALL.get()), new ItemStack(BetterToolsModBlocks.DARK_POLISHED_COPPER_WALL.get()), new ItemStack(BetterToolsModBlocks.POLISHED_TOPAZ_WALL.get()),
		...
		registration.addIngredientInfo(List.of(new ItemStack(BetterToolsModItems.NETHER_DIAMOND_HELMET.get()), new ItemStack(BetterToolsModItems.NETHER_DIAMOND_CHESTPLATE.get()), new ItemStack(BetterToolsModItems.NETHER_DIAMOND_LEGGINGS.get()),
				new ItemStack(BetterToolsModItems.NETHER_DIAMOND_BOOTS.get()), new ItemStack(BetterToolsModItems.CRYSTALLITE_ARMOR_NETHER_DIAMOND_HELMET.get()), new ItemStack(BetterToolsModItems.CRYSTALLITE_ARMOR_NETHER_DIAMOND_CHESTPLATE.get()),
				new ItemStack(BetterToolsModItems.CRYSTALLITE_ARMOR_NETHER_DIAMOND_LEGGINGS.get()), new ItemStack(BetterToolsModItems.CRYSTALLITE_ARMOR_NETHER_DIAMOND_BOOTS.get())), VanillaTypes.ITEM_STACK,
				Component.translatable("jei.better_tools.nether_diamond_armor_info"));
		registration.addIngredientInfo(
		...
		registration.addIngredientInfo(List.of(new ItemStack(BetterToolsModItems.SAPPHIRE_HELMET.get()), new ItemStack(BetterToolsModItems.SAPPHIRE_CHESTPLATE.get()), new ItemStack(BetterToolsModItems.SAPPHIRE_LEGGINGS.get()),
				new ItemStack(BetterToolsModItems.SAPPHIRE_BOOTS.get())), VanillaTypes.ITEM_STACK, Component.translatable("jei.better_tools.sapphire_armor_info"));
		...
		registration.addIngredientInfo(
				List.of(new ItemStack(BetterToolsModItems.TOPAZ_HELMET.get()), new ItemStack(BetterToolsModItems.TOPAZ_CHESTPLATE.get()), new ItemStack(BetterToolsModItems.TOPAZ_LEGGINGS.get()), new ItemStack(BetterToolsModItems.TOPAZ_BOOTS.get())),
				VanillaTypes.ITEM_STACK, Component.translatable("jei.better_tools.topaz_armor_info"));
