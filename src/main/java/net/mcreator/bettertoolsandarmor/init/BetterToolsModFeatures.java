...
public class BetterToolsModFeatures {
	...
	public static final DeferredHolder<Feature<?>, Feature<?>> CRYSTALLITE_CLUSTER_34_FEATURE = REGISTRY.register("crystallite_cluster_34_feature", CrystalliteCluster34FeatureFeature::new);
	public static final DeferredHolder<Feature<?>, Feature<?>> CRYSTALLITE_CLUSTER_36_FEATURE = REGISTRY.register("crystallite_cluster_36_feature", CrystalliteCluster36FeatureFeature::new);
	public static final DeferredHolder<Feature<?>, Feature<?>> DEEPSLATE_RUBY_ORE_FEATURE = REGISTRY.register("deepslate_ruby_ore_feature", DeepslateRubyOreFeatureFeature::new);
	public static final DeferredHolder<Feature<?>, Feature<?>> CRYSTALLITE_CLUSTER_30_DEEPSLATE_FEATURE = REGISTRY.register("crystallite_cluster_30_deepslate_feature", CrystalliteCluster30DeepslateFeatureFeature::new);
	public static final DeferredHolder<Feature<?>, Feature<?>> CRYSTALLITE_CLUSTER_32_DEEPSLATE_FEATURE = REGISTRY.register("crystallite_cluster_32_deepslate_feature", CrystalliteCluster32DeepslateFeatureFeature::new);
	public static final DeferredHolder<Feature<?>, Feature<?>> CRYSTALLITE_CLUSTER_34_DEEPSLATE_FEATURE = REGISTRY.register("crystallite_cluster_34_deepslate_feature", CrystalliteCluster34DeepslateFeatureFeature::new);
	public static final DeferredHolder<Feature<?>, Feature<?>> CRYSTALLITE_CLUSTER_36_DEEPSLATE_FEATURE = REGISTRY.register("crystallite_cluster_36_deepslate_feature", CrystalliteCluster36DeepslateFeatureFeature::new);
	public static final DeferredHolder<Feature<?>, Feature<?>> BLACKSTONE_MAGMA_FEATURE = REGISTRY.register("blackstone_magma_feature", BlackstoneMagmaFeatureFeature::new);
	public static final DeferredHolder<Feature<?>, Feature<?>> BLACKSTONE_MAGMA_REPLACE_NORMAL_MAGMA = REGISTRY.register("blackstone_magma_replace_normal_magma", BlackstoneMagmaReplaceNormalMagmaFeature::new);
}