...
import net.mcreator.bettertoolsandarmor.item.ShrunkMusicItem;
...
import net.mcreator.bettertoolsandarmor.item.MusicDiscBlankItem;
import net.mcreator.bettertoolsandarmor.item.MogusDripDiscItem;
import net.mcreator.bettertoolsandarmor.item.MasterBuilderItem;
...
import net.mcreator.bettertoolsandarmor.item.GlideItem;
...
import net.mcreator.bettertoolsandarmor.item.BlockDanceItem;
...
public class BetterToolsModItems {
	...
	public static final RegistryObject<Item> MUSIC_DISC_BLANK = REGISTRY.register("music_disc_blank", () -> new MusicDiscBlankItem());
	public static final RegistryObject<Item> MASTER_BUILDER = REGISTRY.register("master_builder", () -> new MasterBuilderItem());
	public static final RegistryObject<Item> SHRUNK_MUSIC = REGISTRY.register("shrunk_music", () -> new ShrunkMusicItem());
	public static final RegistryObject<Item> BLOCK_DANCE = REGISTRY.register("block_dance", () -> new BlockDanceItem());
	public static final RegistryObject<Item> GLIDE = REGISTRY.register("glide", () -> new GlideItem());
