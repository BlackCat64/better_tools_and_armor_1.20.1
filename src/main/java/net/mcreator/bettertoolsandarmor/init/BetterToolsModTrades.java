...
public class BetterToolsModTrades {
	...
	public static void registerTrades(VillagerTradesEvent event) {
		...
		if (event.getType() == BetterToolsModVillagerProfessions.JEWELLER.get()) {
			event.getTrades().get(2).add(new BasicItemListing(new ItemStack(BetterToolsModItems.RUBY.get(), 3), new ItemStack(Items.EMERALD), 16, 15, 0.02f));
			event.getTrades().get(2).add(new BasicItemListing(new ItemStack(BetterToolsModItems.SAPPHIRE.get(), 2), new ItemStack(Items.EMERALD), 16, 15, 0.02f));
			...
			event.getTrades().get(3).add(new BasicItemListing(new ItemStack(BetterToolsModItems.TOPAZ.get(), 2), new ItemStack(Items.EMERALD), 16, 15, 0.02f));
