...
public class CustomCreativeTabItems {
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> METAL_BLOCKS_TAB = REGISTRY.register("metal_blocks_tab",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.better_tools.metal_blocks_tab")).icon(() -> new ItemStack(BetterToolsModBlocks.DARK_POLISHED_IRON_BLOCK.get())).displayItems((parameters, tabData) -> {
