...
public class CrystallitePickaxeIronItem extends PickaxeItem {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.better_tools.crystallite_pickaxe_iron.description_0"));
		list.add(Component.translatable("item.better_tools.crystallite_pickaxe_iron.description_1"));
		list.add(Component.translatable("item.better_tools.crystallite_pickaxe_iron.description_2"));
	}
}