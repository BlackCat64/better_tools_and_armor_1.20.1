...
public abstract class DripstoneBootsItem extends ArmorItem {
	public DripstoneBootsItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public SoundEvent getEquipSound() {
				return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("block.dripstone_block.place"));
			}

			@Override
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(Blocks.DRIPSTONE_BLOCK), new ItemStack(Blocks.POINTED_DRIPSTONE));
			}
	...
	public static class Boots extends DripstoneBootsItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "better_tools:textures/models/armor/dripstone__layer_1.png";
		}
	}
}
