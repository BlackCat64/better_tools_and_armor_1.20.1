			...
			if (!itemstack.isEmpty() || flag) {
				...
				if (!((double) f < 0.1D)) {
					...
					if (!p_40668_.isClientSide) {
						...
						abstractarrow.setKnockback(abstractarrow.getKnockback() + 2); // Add 2 to knockback for Crystallite Iron effect
						...
						abstractarrow.getPersistentData().putBoolean("crystallite_iron_upgrade", true);
