...
public class CrystalliteDaggerItem extends SwordItem {
	public CrystalliteDaggerItem() {
		super(new Tier() {
			public int getUses() {
				return 1800;
			}
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.better_tools.crystallite_dagger.description_0"));
	}
}
