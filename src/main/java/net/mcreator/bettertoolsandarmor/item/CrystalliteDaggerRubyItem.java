...
public class CrystalliteDaggerRubyItem extends SwordItem {
	...
	public CrystalliteDaggerRubyItem() {
		super(TOOL_TIER, new Item.Properties().attributes(SwordItem.createAttributes(TOOL_TIER, 6f, -1f)).fireResistant());
	}
