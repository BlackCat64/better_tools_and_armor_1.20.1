			...
			if (!itemstack.isEmpty() || flag) {
				...
				if (!((double) f < 0.1D)) {
					...
					if (!p_40668_.isClientSide) {
						...
						if (p_40670_ <= 71980) // Only allow explosive arrows when fully charged
							abstractarrow.getPersistentData().putBoolean("crystallite_nether_diamond_upgrade", true);
						p_40668_.addFreshEntity(abstractarrow);
						if (p_40670_ <= 71980)
							CrystalliteBowNetherDiamondFiredProcedure.execute(p_40668_, abstractarrow);
					}
