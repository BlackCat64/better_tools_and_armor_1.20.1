...
public class CrystalliteShovelIronItem extends ShovelItem {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.better_tools.crystallite_shovel_iron.description_0"));
		list.add(Component.translatable("item.better_tools.crystallite_shovel_iron.description_1"));
		list.add(Component.translatable("item.better_tools.crystallite_shovel_iron.description_2"));
	}
}