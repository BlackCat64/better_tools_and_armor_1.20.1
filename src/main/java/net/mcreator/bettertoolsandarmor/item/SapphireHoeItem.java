...
public class SapphireHoeItem extends HoeItem {
	...
	public SapphireHoeItem() {
		super(TOOL_TIER, new Item.Properties().attributes(DiggerItem.createAttributes(TOOL_TIER, 2f, -1.5f)));
	}
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.better_tools.sapphire_hoe.description_0"));
	}
