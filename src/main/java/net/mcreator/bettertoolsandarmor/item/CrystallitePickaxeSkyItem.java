...
public class CrystallitePickaxeSkyItem extends PickaxeItem {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.better_tools.crystallite_pickaxe_sky.description_0"));
		list.add(Component.translatable("item.better_tools.crystallite_pickaxe_sky.description_1"));
		list.add(Component.translatable("item.better_tools.crystallite_pickaxe_sky.description_2"));
	}
}