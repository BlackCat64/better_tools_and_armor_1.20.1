...
public class CrystalliteSwordTopazItem extends SwordItem {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.better_tools.crystallite_sword_topaz.description_0"));
		list.add(Component.translatable("item.better_tools.crystallite_sword_topaz.description_1"));
		list.add(Component.translatable("item.better_tools.crystallite_sword_topaz.description_2"));
	}
}
