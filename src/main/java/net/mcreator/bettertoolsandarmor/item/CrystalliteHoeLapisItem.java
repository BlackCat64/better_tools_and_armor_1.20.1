...
public class CrystalliteHoeLapisItem extends HoeItem {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.better_tools.crystallite_hoe_lapis.description_0"));
		list.add(Component.translatable("item.better_tools.crystallite_hoe_lapis.description_1"));
		list.add(Component.translatable("item.better_tools.crystallite_hoe_lapis.description_2"));
	}
