...
public class CrystalliteShovelAmethystItem extends ShovelItem {
	...
	public CrystalliteShovelAmethystItem() {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.better_tools.crystallite_shovel_amethyst.description_0"));
		list.add(Component.translatable("item.better_tools.crystallite_shovel_amethyst.description_1"));
		list.add(Component.translatable("item.better_tools.crystallite_shovel_amethyst.description_2"));
	}
}
