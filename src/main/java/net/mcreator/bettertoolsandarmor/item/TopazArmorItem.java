...
public abstract class TopazArmorItem extends ArmorItem {
	...
	public static class Helmet extends TopazArmorItem {
		...
		public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
			...
			list.add(Component.translatable("item.better_tools.topaz_helmet.description_0"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "better_tools:textures/models/armor/topaz__layer_1.png";
		}
	}
	...
	public static class Chestplate extends TopazArmorItem {
		...
		public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, level, list, flag);
			list.add(Component.translatable("item.better_tools.topaz_chestplate.description_0"));
		}
	...
	public static class Leggings extends TopazArmorItem {
		...
		public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, level, list, flag);
			list.add(Component.translatable("item.better_tools.topaz_leggings.description_0"));
		}

		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "better_tools:textures/models/armor/topaz__layer_2.png";
		}
	}
	...
	public static class Boots extends TopazArmorItem {
		...
		public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
			super.appendHoverText(itemstack, level, list, flag);
			list.add(Component.translatable("item.better_tools.topaz_boots.description_0"));
		}
