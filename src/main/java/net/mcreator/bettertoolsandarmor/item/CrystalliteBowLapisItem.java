...
public class CrystalliteBowLapisItem extends BowItem {
	public CrystalliteBowLapisItem() {
	...
	public boolean isValidRepairItem(ItemStack itemstack, ItemStack repairitem) {
		return Ingredient.of(new ItemStack(BetterToolsModItems.CRYSTALLITE_SHARDS.get()), new ItemStack(BetterToolsModItems.CRYSTALLITE_GEM.get()), new ItemStack(Items.LAPIS_LAZULI)).test(repairitem);
	}
	...
	public AbstractArrow customArrow(AbstractArrow arrow, ItemStack projectileStack, ItemStack weaponStack) {
		...
		arrow.getPersistentData().putBoolean("crystallite_bow_lapis", true);
		return arrow;
	}
}