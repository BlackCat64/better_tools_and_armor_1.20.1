...
public class CrystalliteAxeAmethystItem extends AxeItem {
	public CrystalliteAxeAmethystItem() {
		super(new Tier() {
			public int getUses() {
				return 2400;
			}
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.better_tools.crystallite_axe_amethyst.description_0"));
		list.add(Component.translatable("item.better_tools.crystallite_axe_amethyst.description_1"));
		list.add(Component.translatable("item.better_tools.crystallite_axe_amethyst.description_2"));
	}
}
