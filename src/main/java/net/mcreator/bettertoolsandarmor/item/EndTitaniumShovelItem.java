...
public class EndTitaniumShovelItem extends ShovelItem {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.better_tools.end_titanium_shovel.description_0"));
	}
}