...
public class EndTitaniumDaggerItem extends SwordItem {
	...
	public EndTitaniumDaggerItem() {
		super(TOOL_TIER, new Item.Properties().attributes(SwordItem.createAttributes(TOOL_TIER, 7f, -1.5f)).fireResistant());
	}
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.better_tools.end_titanium_dagger.description_0"));
	}
