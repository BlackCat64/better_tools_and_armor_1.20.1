...
public class CrystalliteSwordAmethystItem extends SwordItem {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.better_tools.crystallite_sword_amethyst.description_0"));
		list.add(Component.translatable("item.better_tools.crystallite_sword_amethyst.description_1"));
		list.add(Component.translatable("item.better_tools.crystallite_sword_amethyst.description_2"));
	}
}
