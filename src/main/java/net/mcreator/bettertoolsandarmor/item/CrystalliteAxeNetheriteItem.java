...
public class CrystalliteAxeNetheriteItem extends AxeItem {
	...
	public CrystalliteAxeNetheriteItem() {
		super(TOOL_TIER, new Item.Properties().attributes(DiggerItem.createAttributes(TOOL_TIER, 11.5f, -3f)).fireResistant());
	}
