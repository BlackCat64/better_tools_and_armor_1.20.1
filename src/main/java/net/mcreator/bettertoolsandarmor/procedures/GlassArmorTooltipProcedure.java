...
public class GlassArmorTooltipProcedure {
	...
	private static void execute(@Nullable Event event, ItemStack itemstack, List<Component> tooltip) {
		if (tooltip == null)
			return;
		if (itemstack.is(ItemTags.create(ResourceLocation.parse("better_tools:glass_armor")))) {
			...
			if (itemstack.is(ItemTags.create(ResourceLocation.parse("better_tools:base_glass_armor")))) {
				tooltip.add(Component.literal("\u00A77Full-set Energy Cost: \u00A7c200 \u00A76/ 5s"));
			} else if (itemstack.is(ItemTags.create(ResourceLocation.parse("better_tools:iron_glass_armor")))) {
				tooltip.add(Component.literal("\u00A77Full-set Energy Cost: \u00A7c160 \u00A76/ 5s"));
			} else if (itemstack.is(ItemTags.create(ResourceLocation.parse("better_tools:diamond_glass_armor")))) {
