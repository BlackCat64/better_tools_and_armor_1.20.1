	...
	public static ItemStack execute(LevelAccessor world, double x, double y, double z, Direction direction, ItemStack itemstack, boolean success) {
		...
		if (success) {
			if (world instanceof ServerLevel projectileLevel) {
				Projectile _entityToSpawn = initArrowProjectile(new LightningStaffDispenserProjectileEntity(BetterToolsModEntities.LIGHTNING_STAFF_DISPENSER_PROJECTILE.get(), projectileLevel), null, (float) 0.2, true, false, false,
