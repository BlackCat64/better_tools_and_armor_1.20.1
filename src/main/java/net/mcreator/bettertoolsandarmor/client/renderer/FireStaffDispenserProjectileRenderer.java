...
public class FireStaffDispenserProjectileRenderer extends EntityRenderer<FireStaffDispenserProjectileEntity> {
	...
	@Override
	public void render(FireStaffDispenserProjectileEntity entityIn, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource bufferIn, int packedLightIn) {
	...
	@Override
	public ResourceLocation getTextureLocation(FireStaffDispenserProjectileEntity entity) {
		return texture;
	}
}
