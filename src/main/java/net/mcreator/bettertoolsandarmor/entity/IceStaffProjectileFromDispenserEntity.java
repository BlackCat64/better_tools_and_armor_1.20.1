...
public class IceStaffProjectileFromDispenserEntity extends AbstractArrow implements ItemSupplier {
	...
	public IceStaffProjectileFromDispenserEntity(EntityType<? extends IceStaffProjectileFromDispenserEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public IceStaffProjectileFromDispenserEntity(EntityType<? extends IceStaffProjectileFromDispenserEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static IceStaffProjectileFromDispenserEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
	...
	public static IceStaffProjectileFromDispenserEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		IceStaffProjectileFromDispenserEntity entityarrow = new IceStaffProjectileFromDispenserEntity(BetterToolsModEntities.ICE_STAFF_PROJECTILE_FROM_DISPENSER.get(), entity, world, null);
	...
	public static IceStaffProjectileFromDispenserEntity shoot(LivingEntity entity, LivingEntity target) {
		IceStaffProjectileFromDispenserEntity entityarrow = new IceStaffProjectileFromDispenserEntity(BetterToolsModEntities.ICE_STAFF_PROJECTILE_FROM_DISPENSER.get(), entity, entity.level(), null);
