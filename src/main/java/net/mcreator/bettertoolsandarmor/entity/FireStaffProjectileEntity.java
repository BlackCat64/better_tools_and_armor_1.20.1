...
public class FireStaffProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public FireStaffProjectileEntity(EntityType<? extends FireStaffProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public FireStaffProjectileEntity(EntityType<? extends FireStaffProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	protected ItemStack getDefaultPickupItem() {
		return new ItemStack(BetterToolsModItems.FIRE_STAFF.get());
	}
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		FireStaffProcedureProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), entityHitResult.getEntity(), this, this.getOwner());
	}

	@Override
	public void onHitBlock(BlockHitResult blockHitResult) {
		super.onHitBlock(blockHitResult);
		FireStaffProjectileMissesProcedure.execute(this.level(), blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(), blockHitResult.getBlockPos().getZ(), this.getOwner(), this);
	}
	...
	public static FireStaffProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
	...
	public static FireStaffProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		FireStaffProjectileEntity entityarrow = new FireStaffProjectileEntity(BetterToolsModEntities.FIRE_STAFF_PROJECTILE.get(), entity, world, null);
	...
	public static FireStaffProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		FireStaffProjectileEntity entityarrow = new FireStaffProjectileEntity(BetterToolsModEntities.FIRE_STAFF_PROJECTILE.get(), entity, entity.level(), null);
