...
public class FireStaffDispenserProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public FireStaffDispenserProjectileEntity(EntityType<? extends FireStaffDispenserProjectileEntity> type, double x, double y, double z, Level world, @Nullable ItemStack firedFromWeapon) {
		super(type, x, y, z, world, PROJECTILE_ITEM, firedFromWeapon);
	}

	public FireStaffDispenserProjectileEntity(EntityType<? extends FireStaffDispenserProjectileEntity> type, LivingEntity entity, Level world, @Nullable ItemStack firedFromWeapon) {
	...
	public static FireStaffDispenserProjectileEntity shoot(Level world, LivingEntity entity, RandomSource source, float pullingPower) {
	...
	public static FireStaffDispenserProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		FireStaffDispenserProjectileEntity entityarrow = new FireStaffDispenserProjectileEntity(BetterToolsModEntities.FIRE_STAFF_DISPENSER_PROJECTILE.get(), entity, world, null);
	...
	public static FireStaffDispenserProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		FireStaffDispenserProjectileEntity entityarrow = new FireStaffDispenserProjectileEntity(BetterToolsModEntities.FIRE_STAFF_DISPENSER_PROJECTILE.get(), entity, entity.level(), null);
