...
package net.mcreator.bettertoolsandarmor.world.inventory;
...
public class EnergyVialMenuMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public EnergyVialMenuMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(BetterToolsModMenus.ENERGY_VIAL_MENU.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 8, 49) {
			...
			public boolean mayPlace(ItemStack stack) {
				return stack.is(ItemTags.create(new ResourceLocation("better_tools:energy_vial_fuels")));
			}
		}));
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof EnergyVialMenuMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			EnergyVialGuiUpdateProcedure.execute(world, entity, guistate);
		}
	}
}
