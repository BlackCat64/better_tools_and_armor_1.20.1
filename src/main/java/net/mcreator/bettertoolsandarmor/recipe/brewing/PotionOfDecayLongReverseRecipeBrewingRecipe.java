...
public class PotionOfDecayLongReverseRecipeBrewingRecipe implements IBrewingRecipe {
	...
	public static void init(RegisterBrewingRecipesEvent event) {
		event.getBuilder().addRecipe(new PotionOfDecayLongReverseRecipeBrewingRecipe());
	}
	...
	public boolean isInput(ItemStack input) {
		...
		return (inputItem == Items.POTION || inputItem == Items.SPLASH_POTION || inputItem == Items.LINGERING_POTION) && optionalPotion.isPresent() && optionalPotion.get().is(BetterToolsModPotions.POTION_OF_DECAY_LONG);
	}
