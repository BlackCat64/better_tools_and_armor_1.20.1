...
public class DoubleJumpPotionLongReverseBrewingRecipe implements IBrewingRecipe {
	...
	public static void init(RegisterBrewingRecipesEvent event) {
		event.getBuilder().addRecipe(new DoubleJumpPotionLongReverseBrewingRecipe());
	}
	...
	public boolean isInput(ItemStack input) {
		...
		return (inputItem == Items.POTION || inputItem == Items.SPLASH_POTION || inputItem == Items.LINGERING_POTION) && optionalPotion.isPresent() && optionalPotion.get().is(BetterToolsModPotions.DOUBLE_JUMP_POTION_LONG);
	}
