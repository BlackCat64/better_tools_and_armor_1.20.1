...
@EventBusSubscriber
public class CriticalityPotionRecipeBrewingRecipe implements IBrewingRecipe {
	@SubscribeEvent
	public static void init(RegisterBrewingRecipesEvent event) {
		event.getBuilder().addRecipe(new CriticalityPotionRecipeBrewingRecipe());
	}
	...
	public boolean isIngredient(ItemStack ingredient) {
		return Ingredient.of(new ItemStack(BetterToolsModItems.GUARDIAN_SPIKE.get())).test(ingredient);
	}
