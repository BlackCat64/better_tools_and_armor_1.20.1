...
public class CriticalityPotion2ReverseRecipeBrewingRecipe implements IBrewingRecipe {
	...
	public static void init(RegisterBrewingRecipesEvent event) {
		event.getBuilder().addRecipe(new CriticalityPotion2ReverseRecipeBrewingRecipe());
	}
	...
	public boolean isInput(ItemStack input) {
		...
		return (inputItem == Items.POTION || inputItem == Items.SPLASH_POTION || inputItem == Items.LINGERING_POTION) && optionalPotion.isPresent() && optionalPotion.get().is(BetterToolsModPotions.CRITICALITY_POTION_2);
	}
